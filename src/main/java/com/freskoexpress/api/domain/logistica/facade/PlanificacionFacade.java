...
import com.freskoexpress.domain.logistica.RutaRepository;
import com.freskoexpress.domain.logistica.Vehiculo;
import com.freskoexpress.domain.logistica.VehiculoRepository;
import com.freskoexpress.domain.logistica.dto.CrearRutaRequest;
import com.freskoexpress.domain.logistica.dto.RutaResponse;
...
public class PlanificacionFacade {
    ...
    public RutaResponse actualizarEstado(Integer idRuta, EstadoRuta nuevoEstado) {
        ...
        if (nuevoEstado == EstadoRuta.en_curso) {
            ruta.setHoraInicioReal(java.time.OffsetDateTime.now());
        }
        if (nuevoEstado == EstadoRuta.completada) {
            ruta.setHoraFinReal(java.time.OffsetDateTime.now());
        }
